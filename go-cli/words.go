...
func registerSDKWords(r *eng.Registry, client *sdk.ChocomilkSDK) {
...
func runOp(client *sdk.ChocomilkSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
