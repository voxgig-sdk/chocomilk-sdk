...
from chocomilk_sdk.utility import register

# Load features
from chocomilk_sdk.feature.base_feature import ChocomilkBaseFeature
from chocomilk_sdk.features import _has_feature, _make_feature
...
class ChocomilkSDK:
    ...
    def get_utility(self):
        return ChocomilkUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ChocomilkSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from chocomilk_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)


    def YouTube(self, data=None) -> "YouTubeEntity":
        """Entity factory: client.YouTube().list() / client.YouTube().load({"id": ...})."""
        from chocomilk_sdk.entity.you_tube_entity import YouTubeEntity
        return YouTubeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ChocomilkSDK":
        if sdkopts is None:
            sdkopts = {}
