...
from chocomilk_sdk.core.helpers import get_ctx_prop, to_map
...
class ChocomilkContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ChocomilkSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ChocomilkResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ChocomilkResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ChocomilkError(code, msg, self)
