# Chocomilk SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ChocomilkSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ChocomilkSDK(...) and ChocomilkSDK.test(...) become
#      ChocomilkSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "chocomilk_sdk"
_SDK_CLASS = "ChocomilkSDK"
