...
module ChocomilkTestRunner
  ...
  def self.env_override(m)
    live = getenv("CHOCOMILK_TEST_LIVE")
    override = getenv("CHOCOMILK_TEST_OVERRIDE")
    ...
    explain = getenv("CHOCOMILK_TEST_EXPLAIN")
    m["CHOCOMILK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ChocomilkTestRunner
Helpers = ChocomilkHelpers
Vs = VoxgigStruct
