...
import (
	...
	vs "github.com/voxgig-sdk/chocomilk-sdk/go/utility/struct"
)

type YouTubeEntity struct {
	name    string
	client  *core.ChocomilkSDK
...
func NewYouTubeEntity(client *core.ChocomilkSDK, entopts map[string]any) *YouTubeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *YouTubeEntity) GetName() string { return e.name }
...
func (e *YouTubeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *YouTubeEntity) Deleted() bool {
	return e.deleted
}


func (e *YouTubeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewYouTubeEntity(e.client, opts)
}

func (e *YouTubeEntity) Data(args ...any) any {
...
func (e *YouTubeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an YouTube; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *YouTubeEntity) DataTyped(data ...YouTube) YouTube {
	if len(data) > 0 {
		return typedFrom[YouTube](e.Data(asMap(data[0])))
	}
	return typedFrom[YouTube](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through YouTube (all fields
// optional at the wire level).
func (e *YouTubeEntity) MatchTyped(match ...YouTube) YouTube {
	if len(match) > 0 {
		return typedFrom[YouTube](e.Match(asMap(match[0])))
	}
	return typedFrom[YouTube](e.Match())
}
...
func (e *YouTubeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *YouTubeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *YouTubeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// YouTubeListMatch and returns []YouTube. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *YouTubeEntity) ListTyped(reqmatch YouTubeListMatch, ctrl map[string]any) ([]YouTube, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[YouTube](res), nil
}



func (e *YouTubeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *YouTubeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *YouTubeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *YouTubeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
