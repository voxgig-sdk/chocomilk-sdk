...
const testSeed = `map[string]any{"entity": map[string]any{"search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "you_tube": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
