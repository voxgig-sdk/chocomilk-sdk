...
class ChocomilkTestRunner
{
    ...
    {
        $live = self::getenv('CHOCOMILK_TEST_LIVE');
        $override = self::getenv('CHOCOMILK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CHOCOMILK_TEST_EXPLAIN');
...
class_alias('ChocomilkTestRunner', 'Runner');
class_alias('ChocomilkHelpers', 'Helpers');
