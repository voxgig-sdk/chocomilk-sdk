...
require_once __DIR__ . '/../chocomilk_sdk.php';
...
{
    private static function utility(): ChocomilkUtility
    {
        return new ChocomilkUtility();
    }
    ...
    private static function ctx(array $over = []): ChocomilkContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ChocomilkContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ChocomilkOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ChocomilkError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ChocomilkOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ChocomilkMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ChocomilkOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ChocomilkMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ChocomilkOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ChocomilkMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChocomilkSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ChocomilkMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ChocomilkResponse([]),
            'result' => new ChocomilkResult([]),
        ]);
        [, $err] = ChocomilkMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ChocomilkSpec([]),
            'response' => null,
            'result' => new ChocomilkResult([]),
        ]);
        [, $err] = ChocomilkMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ChocomilkSpec(['step' => 's']),
            'response' => new ChocomilkResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ChocomilkResult([]),
        ]);
        [, $err] = ChocomilkMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ChocomilkSpec(['step' => 's']),
            'response' => new ChocomilkResponse(self::resp(200, ['v' => 1])),
            'result' => new ChocomilkResult([]),
        ]);
        [, $err] = ChocomilkMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ChocomilkSpec(['step' => 's']),
            'response' => new ChocomilkResponse(self::resp(200, ['v' => 2])),
            'result' => new ChocomilkResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ChocomilkMakeResponse::call($ctx);
    ...
    {
        $preset = new ChocomilkResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ChocomilkSpec([]),
            'response' => new ChocomilkResponse([]),
            'result' => new ChocomilkResult([]),
        ...
        [$got, $err] = ChocomilkMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ChocomilkResult([])]);
        [, $err] = ChocomilkMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ChocomilkSpec([]), 'result' => null]);
        [, $err] = ChocomilkMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChocomilkSpec(['step' => 's']),
            'result' => new ChocomilkResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ChocomilkOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChocomilkMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChocomilkSpec(['step' => 's']),
            'result' => new ChocomilkResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ChocomilkOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChocomilkMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChocomilkResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ChocomilkSpec([]),
            'result' => new ChocomilkResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ChocomilkMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChocomilkMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ChocomilkError('boom', 'boom');
        $utility->fetcher = function (ChocomilkContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChocomilkSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ChocomilkMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ChocomilkContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ChocomilkMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ChocomilkResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ChocomilkContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChocomilkSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ChocomilkMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ChocomilkResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ChocomilkSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ChocomilkMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ChocomilkMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ChocomilkMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ChocomilkResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ChocomilkDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ChocomilkResult(['ok' => false])]);
        $this->expectException(ChocomilkError::class);
        ChocomilkDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ChocomilkResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ChocomilkMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ChocomilkMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ChocomilkBaseFeature();
        $b = new ChocomilkBaseFeature();
        ChocomilkFeatureAdd::call($ctx, $a);
        ChocomilkFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ChocomilkBaseFeature
    {
        $f = new ChocomilkBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ChocomilkFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ChocomilkContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ChocomilkSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChocomilkPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ChocomilkResponse(['headers' => null]),
            'result' => new ChocomilkResult([]),
        ]);
        ChocomilkResultHeaders::call($ctx);
