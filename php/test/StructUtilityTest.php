...
// Chocomilk SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ChocomilkOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ChocomilkOmni::structfix($now, Struct::undef()))
                        !== json_encode(ChocomilkOmni::structfix($val, Struct::undef()))) {
