...
// Chocomilk SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ChocomilkSDK::test)
...
{
    private const SDK_CLASS = 'ChocomilkSDK';
    ...
    private const SDK_BASE = 'chocomilk_sdk';
