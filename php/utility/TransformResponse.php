...
// Chocomilk SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ChocomilkTransformResponse
{
    public static function call(ChocomilkContext $ctx): mixed
    {
        ...
        $transform = ChocomilkHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
