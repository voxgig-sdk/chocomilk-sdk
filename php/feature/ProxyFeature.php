...
class ChocomilkProxyFeature extends ChocomilkBaseFeature
{
    ...
    public function init(ChocomilkContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ChocomilkContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
