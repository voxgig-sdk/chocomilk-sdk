...
// Chocomilk SDK ratelimit feature
...
class ChocomilkRatelimitFeature extends ChocomilkBaseFeature
{
    ...
    private function _acquire(ChocomilkContext $ctx): void
    {
    ...
    private function _track(ChocomilkContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
