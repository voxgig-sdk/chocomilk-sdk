...
// Chocomilk SDK streaming feature
...
class ChocomilkStreamingFeature extends ChocomilkBaseFeature
{
    ...
    private function _iterate(ChocomilkResult $result): \Generator
    {
    ...
    private function _streamable(ChocomilkContext $ctx): bool
    {
