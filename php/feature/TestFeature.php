...
// Chocomilk SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ChocomilkTestFeature extends ChocomilkBaseFeature
{
    ...
    public function init(ChocomilkContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ChocomilkContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ChocomilkParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ChocomilkContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ChocomilkContext $ctx, $op, $args): array
    {
