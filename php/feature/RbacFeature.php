...
class ChocomilkRbacFeature extends ChocomilkBaseFeature
{
    ...
    private function _required(ChocomilkContext $ctx): ?string
    {
    ...
    private function _reject(ChocomilkContext $ctx, string $required): void
    {
    ...
    private function _track(ChocomilkContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
