...
(0, node_test_1.describe)('YouTubeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ChocomilkSDK({
    ...
    (0, node_test_1.test)('direct-list-you_tube', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-you_tube', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CHOCOMILK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ChocomilkSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CHOCOMILK_TEST_YOU_TUBE_ENTID'];
    ...
    const client = new __1.ChocomilkSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=YouTubeDirect.test.js.map