...
function envOverride(m) {
    if ('TRUE' === process.env.CHOCOMILK_TEST_LIVE ||
        'TRUE' === process.env.CHOCOMILK_TEST_OVERRIDE) {
    ...
    m.CHOCOMILK_TEST_EXPLAIN = process.env.CHOCOMILK_TEST_EXPLAIN || m.CHOCOMILK_TEST_EXPLAIN;
    return m;
}
