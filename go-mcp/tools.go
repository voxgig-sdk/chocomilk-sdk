...
type Args struct {
	Entity string         `json:"entity" jsonschema:"search | you_tube"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ChocomilkSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "chocomilk_list",
		Description: "List records from Chocomilk. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "chocomilk_load",
		Description: "Load a single record from Chocomilk. " +
...
func runOp(client *sdk.ChocomilkSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ChocomilkSDK, name string) (sdk.ChocomilkEntity, error) {
	switch strings.ToLower(name) {
	case "search":
		return client.Search(nil), nil
	case "you_tube":
		return client.YouTube(nil), nil
