...
|---|---|---|
| `ts/` | @voxgig-sdk/chocomilk-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/chocomilk-sdk \
      --repository voxgig-sdk/chocomilk-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/chocomilk-sdk` shows it, and
`npm trust revoke @voxgig-sdk/chocomilk-sdk --id=<id>` removes it.
