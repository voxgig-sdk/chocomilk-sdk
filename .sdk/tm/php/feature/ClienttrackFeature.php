...
// Chocomilk SDK clienttrack feature
...
class ChocomilkClienttrackFeature extends ChocomilkBaseFeature
{
    ...
    public function PostConstruct(ChocomilkContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Chocomilk-SDK';
