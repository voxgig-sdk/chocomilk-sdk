...
class ChocomilkCacheFeature extends ChocomilkBaseFeature
{
    ...
    private function _through(ChocomilkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
