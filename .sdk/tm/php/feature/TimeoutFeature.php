...
class ChocomilkTimeoutFeature extends ChocomilkBaseFeature
{
    ...
    private function _with_timeout(ChocomilkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ChocomilkContext $_ctx, float $ms): void
    {
        $client = $this->client;
