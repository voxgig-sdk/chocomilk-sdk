...
class ChocomilkNetsimFeature extends ChocomilkBaseFeature
{
    ...
    private function _simulate(ChocomilkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ChocomilkContext $ctx, array $applied): void
    {
        $client = $this->client;
