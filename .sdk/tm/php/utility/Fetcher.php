...
// Chocomilk SDK utility: fetcher

class ChocomilkFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ChocomilkSDK/1.0)';
    ...
    public static function call(ChocomilkContext $ctx, string $fullurl, array $fetchdef): array
    {
