...
class ChocomilkGraphql
{
    ...
    // equivalent.
    public static function body(ChocomilkContext $ctx): mixed
    {
    ...
    public static function errors(ChocomilkContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
